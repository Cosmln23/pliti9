      ...
      <section className="relative bg-gradient-to-br from-paranormal-900 via-paranormal-800 to-paranormal-700 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            {/* Logo și nume din Sanity */}
            <div className="flex items-center justify-center space-x-4 mb-8">
              {branding?.logo && (
                <div className="w-16 h-16 rounded-xl flex items-center justify-center mystery-glow overflow-hidden">
                  <img 
                    src={urlFor(branding.logo)?.width(64).height(64).url() || ''} 
